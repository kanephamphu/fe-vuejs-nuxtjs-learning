...
declare module "nitropack/types" {
  ...
  interface InternalApi {
    ...
    '/api/lessons/:slug': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/lessons/[slug].get').default>>>>
    }
    '/api/modules': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/modules.get').default>>>>
    }
    '/api/seed': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/seed.get').default>>>>
    }
    '/api/user/progress': {
