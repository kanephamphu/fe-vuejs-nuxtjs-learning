...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getCookie, deleteCookie, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, setCookie, getResponseStatusText } from 'file://D:/Project/Training/VueJS/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://D:/Project/Training/VueJS/node_modules/@vue/shared/dist/shared.cjs.js';
import { sql, eq, and } from 'file://D:/Project/Training/VueJS/node_modules/drizzle-orm/index.js';
import bcrypt from 'file://D:/Project/Training/VueJS/node_modules/bcrypt/bcrypt.js';
import fs, { promises } from 'node:fs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://D:/Project/Training/VueJS/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://D:/Project/Training/VueJS/node_modules/ufo/dist/index.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file://D:/Project/Training/VueJS/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://D:/Project/Training/VueJS/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/Project/Training/VueJS/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://D:/Project/Training/VueJS/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://D:/Project/Training/VueJS/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/Project/Training/VueJS/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://D:/Project/Training/VueJS/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://D:/Project/Training/VueJS/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://D:/Project/Training/VueJS/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://D:/Project/Training/VueJS/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/Project/Training/VueJS/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/Project/Training/VueJS/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/Project/Training/VueJS/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Project/Training/VueJS/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://D:/Project/Training/VueJS/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Project/Training/VueJS/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://D:/Project/Training/VueJS/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/Project/Training/VueJS/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/Project/Training/VueJS/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/Project/Training/VueJS/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://D:/Project/Training/VueJS/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/Project/Training/VueJS/node_modules/errx/dist/index.js';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://D:/Project/Training/VueJS/node_modules/pathe/dist/index.mjs';
import jwt from 'file://D:/Project/Training/VueJS/node_modules/jsonwebtoken/index.js';
import { drizzle } from 'file://D:/Project/Training/VueJS/node_modules/drizzle-orm/better-sqlite3/index.js';
import Database from 'file://D:/Project/Training/VueJS/node_modules/better-sqlite3/lib/index.js';
import { sqliteTable, integer, text } from 'file://D:/Project/Training/VueJS/node_modules/drizzle-orm/sqlite-core/index.js';
import { walkResolver } from 'file://D:/Project/Training/VueJS/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"D:/Project/Training/VueJS/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Project/Training/VueJS","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Project/Training/VueJS/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Project/Training/VueJS/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Project/Training/VueJS/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/Project/Training/VueJS/.data/kv"}));
...
const _NsyiDF95cGNheu2Dd5WC9CezViD5HJDu6FtJKDLy84o = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/Project/Training/VueJS";
...
const _0Y41XDPzSOF98SzvIYxubvjo4s0MSoYKyrS7BIuC8 = (nitroApp) => {
...
const plugins = [
  _NsyiDF95cGNheu2Dd5WC9CezViD5HJDu6FtJKDLy84o,
_0Y41XDPzSOF98SzvIYxubvjo4s0MSoYKyrS7BIuC8
];

const assets = {
  "/index.mjs": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"1a27c-mxugrsjaJ/wxrjkKWL7yrUnnHI8\"",
    "mtime": "2026-01-16T09:15:11.152Z",
    "size": 107132,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"63a02-x29EYM3mGcVwuY3lDq/x+Kjt0fI\"",
    "mtime": "2026-01-16T09:15:11.152Z",
    "size": 408066,
    "path": "index.mjs.map"
  }
...
const _bNIctt = eventHandler((event) => {
...
const lessons = sqliteTable("lessons", {
  ...
  // New field for practice instructions
...
const exercises = sqliteTable("exercises", {
  ...
  // This will be used for the exercise markdown
...
const _AH0gJK = defineEventHandler(async (event) => {
...
const getServerEntry = () => import('file://D:/Project/Training/VueJS/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://D:/Project/Training/VueJS/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_F3ZzKq = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_o5zVh6 = () => Promise.resolve().then(function () { return logout_post$1; });
const _lazy_q51H5i = () => Promise.resolve().then(function () { return me_get$1; });
const _lazy_82kKsd = () => Promise.resolve().then(function () { return register_post$1; });
const _lazy_nhbfZD = () => Promise.resolve().then(function () { return _slug__get$1; });
const _lazy_UDAhGN = () => Promise.resolve().then(function () { return modules_get$1; });
const _lazy_wBeX6R = () => Promise.resolve().then(function () { return seed_get$1; });
const _lazy_kI5pUM = () => Promise.resolve().then(function () { return progress_post$1; });
const _lazy_lqc5fH = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _bNIctt, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _AH0gJK, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/login', handler: _lazy_F3ZzKq, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/logout', handler: _lazy_o5zVh6, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/me', handler: _lazy_q51H5i, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/register', handler: _lazy_82kKsd, lazy: true, middleware: false, method: "post" },
  { route: '/api/lessons/:slug', handler: _lazy_nhbfZD, lazy: true, middleware: false, method: "get" },
  { route: '/api/modules', handler: _lazy_UDAhGN, lazy: true, middleware: false, method: "get" },
  { route: '/api/seed', handler: _lazy_wBeX6R, lazy: true, middleware: false, method: "get" },
  { route: '/api/user/progress', handler: _lazy_kI5pUM, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_lqc5fH, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_lqc5fH, lazy: true, middleware: false, method: undefined }
];
...
const _slug__get = defineEventHandler(async (event) => {
  ...
  let progress = null;
  if (user) {
    progress = await db.select().from(userProgress).where(and(eq(userProgress.userId, user.id), eq(userProgress.lessonId, lesson.id))).get();
  }
...
const seed_get = defineEventHandler(async () => {
  try {
    const modules = {
      javascript: [
...
Complete the challenge.`;
        ...
        if (existingLesson) {
          ...
          }).where(eq(lessons.id, existingLesson.id)).run();
          await db.update(exercises).set({
            instructions: exerciseInstructions
          }).where(eq(exercises.lessonId, existingLesson.id)).run();
          updatedCount++;
        } else {
          const newLesson = await db.insert(lessons).values({
            ...
            practiceContent,
            complexity: lessonData.level
            // Updated to use the level from the registry
          }).returning().get();
...
const seed_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: seed_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const progress_post = defineEventHandler(async (event) => {
  ...
  const existing = await db.select().from(userProgress).where(and(eq(userProgress.userId, user.id), eq(userProgress.lessonId, lessonId))).get();
  ...
  if (existing) {
    ...
    await db.update(userProgress).set(update).where(eq(userProgress.id, existing.id)).run();
  } else {
...
const progress_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
